  ...
  mpa: {
    core: {
      ...
      OperationExecutor: {
        ...
        deploy: true,
        address: '0x7A9d987E34957104B0462F753b194911f8eA0CC8',
      ...
      OperationStorage: {
        ...
        deploy: true,
        address: '0x3ee4D3c2e3DaB1CA70393AF8857624ec98363Be4',
      ...
      OperationsRegistry: {
        ...
        deploy: true,
        address: '0xB1d7F0d78f47ab8aaE10B5740B4056d0BfFa17E1',
      ...
      DSProxyFactory: {
        name: 'DSProxyFactory',
        deploy: true,
        address: '0x0A86fD8Ac2F1C1CEAd9E6039C2df1912B09B7a5D',
      ...
      DSGuardFactory: {
        name: 'DSGuardFactory',
        deploy: true,
        address: '0xB89a6620d5f9E04FD916Ee01d1aa4F7dA5b774Bd',
      ...
      AccountGuard: {
        name: 'AccountGuard',
        deploy: true,
        address: '0x178A2bd3078eB2FFD601977C7A893586Ac6f7171',
      ...
      ChainLogView: {
        name: 'ChainLogView',
        deploy: true,
        address: '0xf25086fa737D82103494576bca9198264CBa5120',
      ...
      Swap: {
        name: 'Swap',
        deploy: true,
        address: '0x33d516D030976c5348DA6aBFEa65BFE37764d7F6',
    ...
    actions: {
      PositionCreated: {
        ...
        deploy: true,
        address: '0x548D96Eea0F9ce3b18250055070b10c49e5138eF',
      ...
      SwapAction: {
        name: 'SwapAction',
        deploy: true,
        address: '0x2c7b806B00B54d3Fbac8CC8B458Cd258a37d57C2',
      ...
      TakeFlashloan: {
        name: 'TakeFlashloan',
        deploy: true,
        address: '0x0942E5E73c76F015Ca57bb601c7Ad07bc33b7cF5',
      ...
      SetApproval: {
        name: 'SetApproval',
        deploy: true,
        address: '0x2AC5467681151DcF9750EFfFf5Ff0BaE1B3762A9',
      ...
      PullToken: {
        name: 'PullToken',
        deploy: true,
        address: '0xdC042d928e41b324Aa22FAb10c641BEfD53cc37F',
      ...
      SendToken: {
        name: 'SendToken',
        deploy: true,
        address: '0xE2e03db9f12FE7066Bff53309A0fa8F4566406B2',
      ...
      WrapEth: {
        name: 'WrapEth',
        deploy: true,
        address: '0x29c2633E9177767C3ae858a14096E11280D76AF2',
      ...
      UnwrapEth: {
        name: 'UnwrapEth',
        deploy: true,
        address: '0x84f2DF81A58BdDdA98322CADa91eC493454591f3',
      ...
      ReturnFunds: {
        name: 'ReturnFunds',
        deploy: true,
        address: '0xaCB6Ae9d3ff461b4d09aD0505fb80f8053b06AF1',
      ...
      AaveBorrow: {
        name: 'AaveBorrow',
        deploy: true,
        address: '0xf5F7Cb8085cDbC70c6c90dde2a5ba5dE84Fea7ea',
      ...
      AaveV3SetEMode: {
        name: 'AaveV3SetEMode',
        deploy: true,
        address: '0x83b0B5FB6EEAA7DfC0Eaa3384bb8c3C31105dED9',
      ...
      AjnaDepositBorrow: {
        ...
        deploy: true,
        address: '0xE256B817010e70d18e8A93a56217a2081D60bEf4',
      ...
      AjnaRepayWithdraw: {
        ...
        deploy: true,
        address: '0x01D55d80C2aE1210E7306041d44b03E1ceDff6C0',

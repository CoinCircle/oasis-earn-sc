...
export const config: SystemConfig = {
  mpa: {
    core: {
      ServiceRegistry: {
        ...
        deploy: true,
        address: '0xa20d57E3B3ADe3BB4581E1C4047642Be1781c178',
        history: [
          '0x9b4Ae7b164d195df9C4Da5d08Be88b2848b2EaDA',
          '0xA172d9618F53c1b480DEC43Cd078c113B79044b2'
        ],
        constructorArgs: [ 0 ]
      },
      OperationExecutor: {
      ...
      AccountGuard: {
        name: 'AccountGuard',
        deploy: true,
        address: '0x37dbacc0Fc9d1b5B2e54e3A72927108eF5930815',
        history: [
          '0xCe91349d2A4577BBd0fC91Fe6019600e047f2847',
          '0xEAEF529Df05D03Dd80531651b6f077598E468e05'
        ],
        constructorArgs: []
      },
      AccountFactory: {
        name: 'AccountFactory',
        deploy: true,
        address: '0x0c30352B6030E3CacFBcFc7F8bE65d4b6c128DF4',
        history: [
          '0xF7B75183A2829843dB06266c114297dfbFaeE2b6',
          '0xCDee5D2891c0CdB4F65adEBf624c6377D0CC2cA0'
        ],
      ...
      Swap: {
        name: 'Swap',
        deploy: true,
        address: '0xABDe2FCF36128D989307Bc91a1D8C8172A15bc3b',
    ...
    actions: {
      ...
      AjnaDepositBorrow: {
        ...
        deploy: true,
        address: '0xDDa0C6EC4190cF50E681cDB6358b3ca459F490d7',
        serviceRegistryName: SERVICE_REGISTRY_NAMES.ajna.DEPOSIT_BORROW,
        history: [ '0xD30bDaa98A520E055bFFF297CaC9B661597C8f69' ],
        constructorArgs: [ 'address:ServiceRegistry' ]
      },
      AjnaRepayWithdraw: {
        name: 'AjnaRepayWithdraw',
        deploy: true,
        address: '0x992Fa1FCD53E8086feBf1200294cDAD97949A2c7',
        serviceRegistryName: SERVICE_REGISTRY_NAMES.ajna.REPAY_WITHDRAW,
        history: [ '0x8897b2b48DF33d7be6d849e4219f3e7A02f8D5e7' ],
        constructorArgs: [ 'address:ServiceRegistry' ]
      }
    }
  },
  common: {
    ...
    FeeRecipient: {
      name: 'FeeRecipient',
      address: '0x588802daA6a39932a51275cEA78f2aE239ea80B5'
    },
    MerkleRedeemer: {
      name: 'MerkleRedeemer',

  ...
  mpa: {
    core: {
      ServiceRegistry: {
        ...
        deploy: true,
        address: '0xA172d9618F53c1b480DEC43Cd078c113B79044b2',
      ...
      OperationExecutor: {
        ...
        deploy: true,
        address: '0x096adB3310802F4d8f565e8E3c02B1660C0F2057',
      ...
      OperationStorage: {
        ...
        deploy: true,
        address: '0x24c0B8249e6fc922c757a43c7149b9Ff03573109',
      ...
      OperationsRegistry: {
        ...
        deploy: true,
        address: '0x1fB447556d19C39A8cCa2e83aE57dFDa23d8Aa47',
      ...
      DSProxyFactory: {
        name: 'DSProxyFactory',
        deploy: true,
        address: '0x414e662B3f95c4c54E735d232A3158ff3BcE160B',
      ...
      DSProxyRegistry: {
        ...
        deploy: true,
        address: '0xCC079FC30B0A8df8f8473D1D489A72e203B5F750',
      ...
      DSGuardFactory: {
        name: 'DSGuardFactory',
        deploy: true,
        address: '0xD3b1eC7e0065DF4ab04eFccB94e8EA2dF2c66064',
      ...
      AccountGuard: {
        name: 'AccountGuard',
        deploy: true,
        address: '0xEAEF529Df05D03Dd80531651b6f077598E468e05',
      ...
      AccountFactory: {
        name: 'AccountFactory',
        deploy: true,
        address: '0xCDee5D2891c0CdB4F65adEBf624c6377D0CC2cA0',
      ...
      ChainLogView: {
        name: 'ChainLogView',
        deploy: true,
        address: '0xd8781c2df5cc9572ed91ea4654e75fc4E44e5a00',
      ...
      Swap: {
        name: 'Swap',
        deploy: true,
        address: '0xeA7E065EB8570d7A92F53CfB7B65D97564fBd128',
    ...
    actions: {
      PositionCreated: {
        ...
        deploy: true,
        address: '0xa598cE7Fc5B3CE83675588B9de6fE28948b918E3',
      ...
      SwapAction: {
        name: 'SwapAction',
        deploy: true,
        address: '0x620C8e3f03Db2f0d133C1c936Be0a132017D15e9',
      ...
      TakeFlashloan: {
        name: 'TakeFlashloan',
        deploy: true,
        address: '0x3cD673c94f22226353806a411B13eC824eBc0a56',
      ...
      SetApproval: {
        name: 'SetApproval',
        deploy: true,
        address: '0x4DE89a7C466cC8fF4e0F91413b31a8386bCb5481',
      ...
      PullToken: {
        name: 'PullToken',
        deploy: true,
        address: '0xf8F6de4907156F5C732d7d995de8d8e44a7256ED',
      ...
      SendToken: {
        name: 'SendToken',
        deploy: true,
        address: '0x501AaC91517f220B8768c4339DC9bBc13F7B24e8',
      ...
      WrapEth: {
        name: 'WrapEth',
        deploy: true,
        address: '0x489985165c7a4B69655A29273B50932d7144B195',
      ...
      UnwrapEth: {
        name: 'UnwrapEth',
        deploy: true,
        address: '0xa7ea4214a0d652208dB3bB34c9B77A11C5668eAa',
      ...
      ReturnFunds: {
        name: 'ReturnFunds',
        deploy: true,
        address: '0x83f68e9E5fe00eac57e0091ed2AFFEA8189cD733',
      ...
      AaveBorrow: {
        name: 'AaveBorrow',
        deploy: true,
        address: '0x6320580f90ae8bd0b969F776A3314fB96b903BCC',
      ...
      AaveWithdraw: {
        name: 'AaveWithdraw',
        deploy: true,
        address: '0x39D0aF0AF1Cba26dd586AfB10549BeEeDbA9dbeB',
      ...
      AaveDeposit: {
        name: 'AaveDeposit',
        deploy: true,
        address: '0xE996020B308A0eaC6965724CA825D09C4C1D6AAa',
      ...
      AavePayback: {
        name: 'AavePayback',
        deploy: true,
        address: '0xb548F077b31cd2e619d4e5cF8A78DC5ce0307A3f',
      ...
      AaveV3Borrow: {
        name: 'AaveV3Borrow',
        deploy: true,
        address: '0x13d9B4A9059d00B486b7E644F1394E804Ea0e18e',
      ...
      AaveV3Withdraw: {
        name: 'AaveV3Withdraw',
        deploy: true,
        address: '0x2c5dbC2409F710483Bf65692b0533F99cf77F226',
      ...
      AaveV3Deposit: {
        name: 'AaveV3Deposit',
        deploy: true,
        address: '0x1Ca3D2584d7565e533e8e7810CFc74d3d00f2fB1',
      ...
      AaveV3Payback: {
        name: 'AaveV3Payback',
        deploy: true,
        address: '0x8b9524aA1dA485da40b110ac13931de88643Fb56',
      ...
      AaveV3SetEMode: {
        name: 'AaveV3SetEMode',
        deploy: true,
        address: '0xBb0B4D8E3609725ddE2078437D6113943356114c',
      ...
      AjnaDepositBorrow: {
        ...
        deploy: true,
        address: '0xD30bDaa98A520E055bFFF297CaC9B661597C8f69',
      ...
      AjnaRepayWithdraw: {
        ...
        deploy: true,
        address: '0x8897b2b48DF33d7be6d849e4219f3e7A02f8D5e7',
